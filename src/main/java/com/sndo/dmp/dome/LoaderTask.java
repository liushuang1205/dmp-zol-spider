...
public class LoaderTask {
    ...
    public LoaderTask(LoaderConfig config) {
        ...
        appGameCollection = MongoServer.getCollection(config.getOnlineDB(), config.getOnlineGameCol());
        zolGameCollection = MongoServer.getCollection(config.getSrcDB(), config.getSrcCol());
